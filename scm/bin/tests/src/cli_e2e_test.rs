...
fn test_navigate_changes_real_page_content() {
    ...
    let output = cli()
        ...
        .output()
        .expect("failed to run browse navigate");
...
fn test_wait_succeeds_when_selector_present() {
    ...
    let output = cli()
        ...
        .output()
        .expect("failed to run browse wait");
...
fn test_click_dispatches_real_mouse_event() {
    ...
    let output = cli()
        ...
        .output()
        .expect("failed to run browse click");
...
fn test_input_types_real_text_into_field() {
    ...
    let output = cli()
        ...
        .output()
        .expect("failed to run browse input");
...
fn test_set_files_sets_a_real_file_and_fires_change() {
    ...
    let output = cli()
        ...
        .output()
        .expect("failed to run browse set-files");
...
fn test_screenshot_writes_real_png_file() {
    ...
    let output = cli()
        ...
        .output()
        .expect("failed to run browse screenshot");
...
fn test_get_dom_exports_real_document_tree() {
    ...
    let output = cli()
        ...
        .output()
        .expect("failed to run browse get-dom");
...
fn test_metrics_returns_real_performance_metrics() {
    ...
    let output = cli()
        ...
        .output()
        .expect("failed to run browse metrics");
...
/// Spawn `browse mock` in the background (it blocks until
...
fn spawn_mock_and_wait_ready(
    ...
    let mut child = cli()
        ...
        .spawn()
        .expect("failed to spawn browse mock");
...
fn test_normal_commands_are_unaffected_when_mock_is_never_invoked() {
    ...
    // browse's behavior is byte-for-byte the same as it was
